...
const translationPt = {
  ...
  'nav.builder': 'Criador de templates',
  'nav.builderDescription': 'Monte programas reutilizáveis',
  ...
  'client.messages.loading': 'Carregando mensagens…',
  'client.messages.inputLabel': 'Mensagem',
  'client.messages.placeholder': 'Escreva um check-in rápido',
  'client.messages.submit': 'Enviar mensagem',
  ...
  'client.metrics.loading': 'Carregando métricas…',
  'client.metrics.nameLabel': 'Nome da métrica',
  'client.metrics.namePlaceholder': 'Ex.: Peso corporal',
  'client.metrics.valueLabel': 'Valor',
  'client.metrics.unitLabel': 'Unidade',
  'client.metrics.unitPlaceholder': 'kg, cm, %',
  'client.metrics.recordedAtLabel': 'Data',
  'client.metrics.submit': 'Registrar métrica',
  ...
  'plans.page.eyebrow': 'Biblioteca de planos',
  'plans.page.title': 'Templates disponíveis',
  'plans.page.subtitle': 'Visualize e organize todos os planos reutilizáveis.',
  'plans.page.loading': 'Carregando templates…',
  'plans.page.empty': 'Nenhum template criado ainda.',
  'plans.page.planLabel': 'Template',
  'plans.page.exerciseCount': 'Exercícios',
  'plans.page.setCount': 'Séries totais',
  'library.page.eyebrow': 'Catálogo de exercícios',
  'library.page.title': 'Biblioteca',
  'library.page.subtitle': 'Referência única dos exercícios usados nos planos e treinos.',
  'library.page.empty': 'Crie um template para começar a preencher sua biblioteca.',
  'library.page.exerciseColumn': 'Exercício',
  'library.page.groupColumn': 'Grupo muscular',
  'library.page.levelColumn': 'Nível',
  'library.page.usageColumn': 'Uso total',
  'messages.page.eyebrow': 'Comunicação ativa',
  'messages.page.title': 'Mensagens dos clientes',
  'messages.page.subtitle': 'Centralize check-ins e feedbacks em um só lugar.',
  'messages.page.empty': 'Cadastre um cliente para começar a receber mensagens.',
  'messages.page.clientLabel': 'Selecionar cliente',
  'reports.page.eyebrow': 'Insights',
  'reports.page.title': 'Relatórios e métricas',
  'reports.page.subtitle': 'Acompanhe indicadores e métricas registradas.',
  'reports.page.empty': 'Ainda não há métricas registradas.',
  'reports.page.clientLabel': 'Cliente',
  'reports.page.clientCount': 'Clientes ativos',
  'reports.page.workoutCount': 'Treinos atribuídos',
...
const translationEn: Record<TranslationKey, string> = {
  ...
  'nav.builder': 'Template builder',
  'nav.builderDescription': 'Craft reusable programmes',
  'nav.clients': 'Clients',
  ...
  'client.messages.loading': 'Loading messages…',
  'client.messages.inputLabel': 'Message',
  'client.messages.placeholder': 'Write a quick check-in',
  'client.messages.submit': 'Send message',
  ...
  'client.metrics.loading': 'Loading metrics…',
  'client.metrics.nameLabel': 'Metric name',
  'client.metrics.namePlaceholder': 'e.g. Bodyweight',
  'client.metrics.valueLabel': 'Value',
  'client.metrics.unitLabel': 'Unit',
  'client.metrics.unitPlaceholder': 'kg, cm, %',
  'client.metrics.recordedAtLabel': 'Date',
  'client.metrics.submit': 'Log metric',
  ...
  'plans.page.eyebrow': 'Plan library',
  'plans.page.title': 'Available templates',
  'plans.page.subtitle': 'Review and organise every reusable plan.',
  'plans.page.loading': 'Loading templates…',
  'plans.page.empty': 'No templates yet.',
  'plans.page.planLabel': 'Template',
  'plans.page.exerciseCount': 'Exercises',
  'plans.page.setCount': 'Total sets',
  'library.page.eyebrow': 'Exercise catalog',
  'library.page.title': 'Library',
  'library.page.subtitle': 'Single source of truth for every exercise across plans.',
  'library.page.empty': 'Create a template to populate your library.',
  'library.page.exerciseColumn': 'Exercise',
  'library.page.groupColumn': 'Muscle group',
  'library.page.levelColumn': 'Level',
  'library.page.usageColumn': 'Usage',
  'messages.page.eyebrow': 'Active comms',
  'messages.page.title': 'Client messages',
  'messages.page.subtitle': 'Centralise check-ins and feedback in one view.',
  'messages.page.empty': 'Add a client to start exchanging messages.',
  'messages.page.clientLabel': 'Select client',
  'reports.page.eyebrow': 'Insights',
  'reports.page.title': 'Reports & metrics',
  'reports.page.subtitle': 'Track progress indicators and logged metrics.',
  'reports.page.empty': 'No metrics recorded yet.',
  'reports.page.clientLabel': 'Client',
  'reports.page.clientCount': 'Active clients',
  'reports.page.workoutCount': 'Assigned workouts',
