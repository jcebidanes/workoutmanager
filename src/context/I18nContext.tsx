...
const translationPt = {
  ...
  'client.messages.latestMessage': 'Última mensagem',
  'client.messages.inputRequired': 'Escreva uma mensagem antes de enviar.',
  ...
  'client.metrics.latestMetric': 'Última métrica registrada',
  'client.metrics.nameRequired': 'Informe o nome da métrica.',
  'client.metrics.valueRequired': 'Informe um valor numérico para a métrica.',
  ...
  'plans.page.totalTemplates': 'Templates ativos',
  'plans.page.totalExercises': 'Exercícios cadastrados',
  'plans.page.totalSets': 'Séries planejadas',
  'plans.page.searchLabel': 'Buscar template',
  'plans.page.searchPlaceholder': 'Nome, descrição ou exercício',
  'plans.page.filteredEmpty': 'Nenhum template corresponde à busca.',
  ...
  'library.page.groupFilter': 'Filtrar por grupo muscular',
  'library.page.levelFilter': 'Filtrar por dificuldade',
  'library.page.allOption': 'Todos',
  'library.page.filteredEmpty': 'Nenhum exercício corresponde aos filtros.',
  'library.page.unknownValue': 'Não informado',
  ...
  'messages.page.clientCount': 'Clientes ativos',
  'messages.page.workoutCount': 'Treinos planejados',
  'messages.page.selectedClientWorkouts': 'Workouts do cliente selecionado',
  ...
  'reports.page.exerciseCount': 'Exercícios ativos',
  'reports.page.tableClient': 'Cliente',
  'reports.page.tableWorkouts': 'Workouts',
  'reports.page.tableExercises': 'Exercícios',
  'reports.page.tableLastWorkout': 'Último treino',
...
const translationEn: Record<TranslationKey, string> = {
  ...
  'client.messages.latestMessage': 'Latest message',
  'client.messages.inputRequired': 'Write a message before sending.',
  ...
  'client.metrics.latestMetric': 'Latest recorded metric',
  'client.metrics.nameRequired': 'Provide a metric name.',
  'client.metrics.valueRequired': 'Provide a numeric value for the metric.',
  ...
  'plans.page.totalTemplates': 'Active templates',
  'plans.page.totalExercises': 'Exercises catalogued',
  'plans.page.totalSets': 'Scheduled sets',
  'plans.page.searchLabel': 'Search template',
  'plans.page.searchPlaceholder': 'Name, description, or exercise',
  'plans.page.filteredEmpty': 'No template matches your search.',
  ...
  'library.page.groupFilter': 'Filter by muscle group',
  'library.page.levelFilter': 'Filter by difficulty',
  'library.page.allOption': 'All',
  'library.page.filteredEmpty': 'No exercise matches your filters.',
  'library.page.unknownValue': 'Not provided',
  ...
  'messages.page.clientCount': 'Active clients',
  'messages.page.workoutCount': 'Workouts planned',
  'messages.page.selectedClientWorkouts': 'Selected client workouts',
  'reports.page.eyebrow': 'Insights',
  ...
  'reports.page.exerciseCount': 'Active exercises',
  'reports.page.tableClient': 'Client',
  'reports.page.tableWorkouts': 'Workouts',
  'reports.page.tableExercises': 'Exercises',
  'reports.page.tableLastWorkout': 'Last workout',
